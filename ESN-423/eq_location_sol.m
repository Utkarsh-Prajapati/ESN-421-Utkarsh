...
% initial location to create travel time (where actual earthquake took
% place)
eqloc_actual = [0,0,10];
...
for ii=1:n_iterations
    ...
    G(:,4) = dgdt(xrec,yrec,zrec,m1,m2,m3,m5);
